...
df_final = df.drop(columns=["Unnamed: 0","Unnamed: 6","Unnamed: 9","Unnamed: 10","Unnamed: 11", "Unnamed: 12", "Unnamed: 13","Unnamed: 14", "Unnamed: 15", "Unnamed: 16"])
df_final.columns = ['Country', 'Confirmed','New Confirmed','Deaths', 'New Deaths','Serious & Critical','Recovered']
...
layout = html.Div([
    dcc.Dropdown(id='dropdown', options=[
        {'label': i, 'value': i} for i in df_country.Country.unique()
    ], multi=True, placeholder='Search by Country ...'),
